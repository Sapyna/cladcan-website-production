...
const systems = [
  { number:"01", title:"Aluminum", subtitle:"Solid & Woodgrain Finish", text:"Durable, non-combustible aluminum siding and soffit available in architectural profiles, colours and woodgrain finishes.", href:"/exterior-systems/aluminum", image:"/images/exterior-systems/aluminum.jpg" },
  { number:"02", title:"Steel", subtitle:"Solid & Woodgrain Finish", text:"Exposed- and hidden-fastener steel systems for residential, commercial, architectural and industrial applications.", href:"/exterior-systems/steel", image:"/images/exterior-systems/steel.jpg" },
  { number:"03", title:"Natural Wood", subtitle:"Siding & Soffit", text:"Authentic warmth, texture and character for premium exterior siding, soffit and architectural accents.", href:"/exterior-systems/natural-wood", image:"/images/exterior-systems/natural-wood.webp" },
  ...
  { number:"05", title:"APP", subtitle:"Aluminum Plate Panel", text:"Solid aluminum plate systems for high-performance drained and back-ventilated rainscreen applications.", href:"/exterior-systems/app", image:"/images/exterior-systems/app-panel.webp" },
  { number:"06", title:"Stucco", subtitle:"EIFS", text:"Continuous-insulation exterior systems combining energy performance with extensive finish flexibility.", href:"/exterior-systems/stucco-eifs", image:"/images/exterior-systems/stucco.jpeg" },
  { number:"07", title:"Fibre Cement", subtitle:"Architectural Cladding", text:"Durable and low-maintenance exterior cladding engineered for demanding Canadian weather conditions.", href:"/exterior-systems/fibre-cement", image:"/images/exterior-systems/fibre-cement.jpg" },
  { number:"08", title:"IMP", subtitle:"Insulated Metal Panel", text:"Integrated metal and insulation systems for efficient commercial and industrial building envelopes.", href:"/exterior-systems/imp", image:"/images/exterior-systems/imp.jpg" },
  { number:"09", title:"PVC", subtitle:"Siding & Soffit", text:"Cost-effective, durable and low-maintenance uPVC exterior systems in a range of profiles and finishes.", href:"/exterior-systems/pvc", image:"/images/exterior-systems/pvc.jpg" },
  { number:"10", title:"WPC", subtitle:"Wood Plastic Composite", text:"Composite architectural profiles combining the appearance of wood with reduced maintenance.", href:"/exterior-systems/wpc", image:"/images/exterior-systems/wpc.jpeg" },
  { number:"11", title:"Trims & Flashings", subtitle:"Custom Fabrication", text:"Custom metal components for openings, corners, transitions, terminations and water management.", href:"/exterior-systems/trims-flashings", image:"/images/exterior-systems/trims.jpg" },
