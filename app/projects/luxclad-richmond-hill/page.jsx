...
export default function Page(){
  return <ProjectShowcase
    ...
    images={[
      ...
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-before-renovation-front.webp",alt:"Front of Richmond Hill Medical Mall before ACM facade renovation",caption:"Before · front elevation",phase:"Before"},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-before-renovation-side.webp",alt:"Side of Richmond Hill Medical Mall before ACM facade renovation",caption:"Before · side elevation",phase:"Before"},
      ...
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-design-render.webp",alt:"Architectural design rendering for Richmond Hill Medical Mall ACM facade",caption:"Design · ACM facade rendering",phase:"Design"},
      ...
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-wide-view.webp",alt:"Completed Richmond Hill Medical Mall ACM facade wide view",caption:"Completed · wide facade view",phase:"Completed",hero:true},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-front-elevation.webp",alt:"Completed front elevation of Richmond Hill Medical Mall ACM facade",caption:"Completed · front elevation",phase:"Completed"},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-front-perspective.webp",alt:"Completed Richmond Hill Medical Mall ACM facade front perspective",caption:"Completed · front perspective",phase:"Completed"},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-corner.webp",alt:"Completed corner of Richmond Hill Medical Mall ACM facade",caption:"Completed · corner view",phase:"Completed"},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-side-perspective.webp",alt:"Completed Richmond Hill Medical Mall ACM facade side perspective",caption:"Completed · side perspective",phase:"Completed"},
      {src:"/images/projects/richmond-hill-medical-mall/richmond-hill-medical-mall-acm-facade-completed-side-closeup.webp",alt:"Close-up of completed ACM panel detailing at Richmond Hill Medical Mall",caption:"Completed · ACM panel detail",phase:"Completed"},
