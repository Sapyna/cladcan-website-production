...
export default function CurrentSitePage({eyebrow="EXTERIOR SYSTEMS",title,intro,image="/images/before-after/william-rose-after.jpg",overview,items=[],note,decisionSupport=[]}){
